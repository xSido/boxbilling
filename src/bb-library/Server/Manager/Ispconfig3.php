...
class Server_Manager_Ispconfig3 extends Server_Manager
{
    ...
    public function init()
    {
        if (!extension_loaded("soap")) {
            throw new Server_Exception(
                "PHP Soap extension required for IspConfig server manager"
            );
        }
        ...
        try {
            ...
            if (
                strpos(
                    ...
                    strtolower("domain_error_unique")
                ) === false
            ) {
    ...
    private function _request($action, $params = [])
    {
        $this->getLog()->debug(
            sprintf(
                'ISP Config 3 action "%s" called with params: "%s" ',
                $action,
                print_r($params, 1)
            )
        );
        ...
        try {
            switch ($action) {
                case "client_add":
                    $reseller_id = 1;
                    $soap_result = $soap_client->client_add(
                        $this->_session,
                        $reseller_id,
                        $params
                    );
                    break;
                case "client_get":
                    $soap_result = $soap_client->client_get(
                        $this->_session,
                        $params["client_id"]
                    );
                    break;
                case "client_get_by_username":
                    $soap_result = $soap_client->client_get_by_username(
                        $this->_session,
                        $params["username"]
                    );
                    break;
                case "client_get_sites_by_user":
                    $soap_result = $soap_client->client_get_sites_by_user(
                        $this->_session,
                        $params["sys_userid"],
                        $params["groups"]
                    );
                    break;
                case "client_delete":
                    $soap_result = $soap_client->client_delete(
                        $this->_session,
                        $params["client_id"]
                    );
                    break;
                case "client_update":
                    $soap_result = $soap_client->client_update(
                        $this->_session,
                        $params["client_id"],
                        $params["reseller_id"],
                        $params
                ...
                case "client_change_password":
                    $soap_result = $soap_client->client_change_password(
                        $this->_session,
                        $params["client_id"],
                        $params["password"]
                    );
                ...
                case "sites_web_domain_update":
                    ...
                    $soap_result = $soap_client->sites_web_domain_update(
                        $this->_session,
                        $client_id,
                        $primary_id,
                        $params
                ...
                case "sites_web_domain_active":
                    $primary_id = $params["primary_id"]; //site id
                    $soap_result = $soap_client->sites_web_domain_set_status(
                        $this->_session,
                        $primary_id,
                        "active"
                    );
                ...
                case "sites_web_domain_add":
                    ...
                    $soap_result = $soap_client->sites_web_domain_add(
                        $this->_session,
                        $client_id,
                        $params
                    );
                ...
                */
                case "sites_web_subdomain_add":
                    $client_id = $params["client_id"];
                    $params["client_id"] = null;
                    $soap_result = $soap_client->sites_web_subdomain_add(
                        $this->_session,
                        $client_id,
                        $params
                    );
                ...
                case "sites_web_domain_get":
                    $soap_result = $soap_client->sites_web_domain_get(
                        $this->_session,
                        $params["primary_id"]
                    );
                    break;
                //Get server info
                case "server_get":
                    $soap_result = $soap_client->server_get(
                        $this->_session,
                        $params["server_id"],
                        $params["section"]
                ...
                case "dns_zone_add":
                    $client_id = $params["client_id"]; // client id
                    $params["client_id"] = null;
                    $soap_result = $soap_client->dns_zone_add(
                        $this->_session,
                        $client_id,
                        $params
                    );
                    break;
                case "dns_zone_get":
                    $soap_result = $soap_client->dns_zone_get(
                        $this->_session,
                        $client_id,
                        $params
                    );
                ...
                case "dns_zone_get_by_user":
                    $client_id = $params["client_id"]; // client id
                    $soap_result = $soap_client->dns_zone_get_by_user(
                        $this->_session,
                        $client_id,
                        $params
                    );
                ...
                case "dns_zone_inactive":
                    $primary_id = $params["primary_id"]; // client id
                    $soap_result = $soap_client->dns_zone_set_status(
                        $this->_session,
                        $primary_id,
                        "inactive"
                    );
                ...
                case "dns_a_add":
                    $client_id = $params["client_id"]; // client id
                    $soap_result = $soap_client->dns_a_add(
                        $this->_session,
                        $client_id,
                        $params
                    );
                ...
                case "mail_domain_add":
                    $client_id = $params["client_id"]; // client id
                    $params["client_id"] = null;
                    $soap_result = $soap_client->mail_domain_add(
                        $this->_session,
                        $client_id,
                        $params
                    );
                ...
                case "mail_domain_update":
                    $client_id = $params["client_id"]; // client id
                    $params["client_id"] = null;
                    $soap_result = $soap_client->mail_domain_update(
                        $this->_session,
                        $client_id,
                        $params
                    );
                ...
                case "mail_domain_active":
                    ...
                    $soap_result = $soap_client->mail_domain_set_status(
                        $this->_session,
                        $primary_id,
                        "active"
                    );
                ...
                case "mail_domain_get_by_domain":
                    ...
                    $soap_result = $soap_client->mail_domain_get_by_domain(
                        $this->_session,
                        $domain
                    );
                    break;
                ...
                case "sites_database_add":
                    $client_id = $params["client_id"]; // client id
                    $params["client_id"] = null;
                    $soap_result = $soap_client->sites_database_add(
                        $this->_session,
                        $client_id,
                        $params
                    );
                ...
                case "sites_database_get":
                    $client_id = $params["client_id"]; // client id
                    $params["client_id"] = null;
                    $soap_result = $soap_client->sites_database_get(
                        $this->_session,
                        $client_id,
                        $params
                    );
                ...
                case "sites_database_get_all_by_user":
                    $client_id = $params["client_id"]; // client id
                    $params["client_id"] = null;
                    $soap_result = $soap_client->sites_database_get_all_by_user(
                        $this->_session,
                        $client_id,
                        $params
                    );
                ...
                case "install_chamilo":
                    $client_id = $params["client_id"]; // client id
                    $params["client_id"] = null;
                    $soap_result = $soap_client->install_chamilo(
                        $this->_session,
                        $client_id,
                        $params
                    );
                ...
                case "client_templates_get_all":
                    $soap_result = $soap_client->client_templates_get_all(
                        $this->_session
                    );
                    break;
                case "test":
                    $soap_result = $soap_client->dns_zone_get_id(
                        $this->_session,
                        $params["origin"]
                    );
                    break;
                case "dns_ns_add":
                    $soap_result = $soap_client->dns_ns_add(
                        $this->_session,
                        $params["client_id"],
                        $params
                    );
                ...
                case "dns_zone_delete":
                    $soap_result = $soap_client->dns_zone_delete(
                        $this->_session,
                        $params
                    );
                    break;
