...
class mailSetDomainMailboxLimits extends openSRS_mail
{
    private $_dataObject;
    ...
    private function _validateObject()
    {
        ...
        if (
            isset($this->_dataObject->data->filter_only) ||
            $this->_dataObject->data->filter_only != ""
        ) {
            $compile .=
                " filter_only=\"" .
                $this->_dataObject->data->filter_only .
        ...
        if (
            isset($this->_dataObject->data->alias) ||
            $this->_dataObject->data->alias != ""
        ) {
            $compile .= " alias=\"" . $this->_dataObject->data->alias . "\"";
        }
        if (
            isset($this->_dataObject->data->forward_only) ||
            $this->_dataObject->data->forward_only != ""
        ) {
            $compile .=
                " forward_only=\"" .
                $this->_dataObject->data->forward_only .
        ...
        if (
            isset($this->_dataObject->data->mailing_list) ||
            $this->_dataObject->data->mailing_list != ""
        ) {
            $compile .=
                " mailing_list=\"" .
                $this->_dataObject->data->mailing_list .
