...
class subresCreate extends openSRS_base
{
    private $_dataObject;
    ...
    private function _processRequest()
    {
        $cmd = [
            ...
            "attributes" => [
                ...
                "low_balance_email" =>
                    $this->_dataObject->data->low_balance_email,
                ...
                "system_status_email" =>
                    $this->_dataObject->data->system_status_email,
        ...
        if (
            ...
            for ($i = 0; $i < count($tmpArray); $i++) {
                $cmd["attributes"]["nameservers"]["fqdn" . ($i + 1)] =
                    $tmpArray[$i];
            }
        }
