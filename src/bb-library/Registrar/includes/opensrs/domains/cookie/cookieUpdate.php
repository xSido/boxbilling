...
class cookieUpdate extends openSRS_base
{
    ...
    private function _validateObject()
    {
        ...
        if (!isset($this->_dataObject->data->reg_username)) {
            trigger_error(
                "oSRS Error - Username string not defined.",
                E_USER_WARNING
            );
            $allPassed = false;
        }
        ...
        if (!isset($this->_dataObject->data->reg_password)) {
            trigger_error(
                "oSRS Error - Password string not defined.",
                E_USER_WARNING
            );
            $allPassed = false;
        }
        ...
        if (!isset($this->_dataObject->data->domain)) {
            trigger_error(
                "oSRS Error - Existing domain strinng not defined.",
                E_USER_WARNING
            );
            $allPassed = false;
        }
        ...
        if (!isset($this->_dataObject->data->domain_new)) {
            trigger_error(
                "oSRS Error - New domain strinng not defined.",
                E_USER_WARNING
            );
            $allPassed = false;
        }
        ...
        if (!isset($this->_dataObject->data->cookie)) {
            trigger_error(
                "oSRS Error - Cookie code not defined.",
                E_USER_WARNING
            );
            $allPassed = false;
        }
