...
class transGetIn extends openSRS_base
{
    ...
    private function _processRequest()
    {
        ...
        if (
            ...
            $cmd["attributes"]["completed_from"] =
                $this->_dataObject->data->completed_from;
        }
        if (
            isset($this->_dataObject->data->completed_to) &&
            $this->_dataObject->data->completed_to != ""
        ) {
            $cmd["attributes"]["completed_to"] =
                $this->_dataObject->data->completed_to;
        }
        if (
        ...
        if (
            ...
            $cmd["attributes"]["gaining_registrar"] =
                $this->_dataObject->data->gaining_registrar;
        }
        if (
        ...
        if (
            ...
            $cmd["attributes"]["owner_confirm_from"] =
                $this->_dataObject->data->owner_confirm_from;
        }
        if (
            ...
            $cmd["attributes"]["owner_confirm_ip"] =
                $this->_dataObject->data->owner_confirm_ip;
        }
        if (
            ...
            $cmd["attributes"]["owner_confirm_to"] =
                $this->_dataObject->data->owner_confirm_to;
        }
        if (
            ...
            $cmd["attributes"]["owner_request_from"] =
                $this->_dataObject->data->owner_request_from;
        }
        if (
            ...
            $cmd["attributes"]["owner_request_to"] =
                $this->_dataObject->data->owner_request_to;
        }
        if (
        ...
        if (
            ...
            $cmd["attributes"]["request_address"] =
                $this->_dataObject->data->request_address;
        }
        if (
        ...
        if (
            ...
            $cmd["attributes"]["losing_registrar"] =
                $this->_dataObject->data->losing_registrar;
        }
