...
class persUpdate extends openSRS_base
{
    ...
    private function _processRequest()
    {
        ...
        if (
            ...
            $cmd["attributes"]["mailbox"]["mailbox_type"] =
                $this->_dataObject->data->mailbox_type;
        }
        if (
            ...
            $cmd["attributes"]["mailbox"]["password"] =
                $this->_dataObject->data->password;
        }
        if (
            ...
            $cmd["attributes"]["mailbox"]["disable_forward_email"] =
                $this->_dataObject->data->disable_forward_email;
        }
        if (
            ...
            $cmd["attributes"]["mailbox"]["forward_email"] =
                $this->_dataObject->data->forward_email;
        }
        if (
            ...
            $cmd["attributes"]["dnsRecords"][0]["type"] =
                $this->_dataObject->data->type;
        }
        if (
            ...
            $cmd["attributes"]["dnsRecords"][0]["name"] =
                $this->_dataObject->data->name;
        }
        if (
            ...
            $cmd["attributes"]["dnsRecords"][0]["content"] =
                $this->_dataObject->data->content;
        }
