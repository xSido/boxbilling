...
class bulkTransfer extends openSRS_base
{
    ...
    private function _validateObject()
    {
        ...
        if (
            ...
            trigger_error(
                "oSRS Error - custom_tech_contact is not defined.",
                E_USER_WARNING
            );
            $allPassed = false;
        }
        if (
            ...
            trigger_error(
                "oSRS Error - domain_list is not defined.",
                E_USER_WARNING
            );
            $allPassed = false;
        }
        if (
            ...
            trigger_error(
                "oSRS Error - reg_username is not defined.",
                E_USER_WARNING
            );
            $allPassed = false;
        }
        if (
            ...
            trigger_error(
                "oSRS Error - reg_password is not defined.",
                E_USER_WARNING
            );
            $allPassed = false;
        }
    ...
    {
        $this->_dataObject->data->domain_list = explode(
            ",",
            $this->_dataObject->data->domain_list
        );
