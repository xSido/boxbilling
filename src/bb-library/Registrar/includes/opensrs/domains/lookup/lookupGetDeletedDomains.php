...
class lookupGetDeletedDomains extends openSRS_base
{
    ...
    private function _processRequest()
    {
        ...
        if (
            isset($this->_dataObject->data->owner_email) &&
            $this->_dataObject->data->owner_email != ""
        ) {
            $cmd["attributes"]["owner_email"] =
                $this->_dataObject->data->owner_email;
        }
        if (
            isset($this->_dataObject->data->admin_email) &&
            $this->_dataObject->data->admin_email != ""
        ) {
            $cmd["attributes"]["admin_email"] =
                $this->_dataObject->data->admin_email;
        }
        if (
            isset($this->_dataObject->data->billing_email) &&
            $this->_dataObject->data->billing_email != ""
        ) {
            $cmd["attributes"]["billing_email"] =
                $this->_dataObject->data->billing_email;
        }
        if (
            isset($this->_dataObject->data->tech_email) &&
            $this->_dataObject->data->tech_email != ""
        ) {
            $cmd["attributes"]["tech_email"] =
                $this->_dataObject->data->tech_email;
        }
        if (
            isset($this->_dataObject->data->del_from) &&
            $this->_dataObject->data->del_from != ""
        ) {
            $cmd["attributes"]["del_from"] = $this->_dataObject->data->del_from;
        }
        if (
            isset($this->_dataObject->data->del_to) &&
            $this->_dataObject->data->del_to != ""
        ) {
            $cmd["attributes"]["del_to"] = $this->_dataObject->data->del_to;
        }
        if (
            isset($this->_dataObject->data->exp_from) &&
            $this->_dataObject->data->exp_from != ""
        ) {
            $cmd["attributes"]["exp_from"] = $this->_dataObject->data->exp_from;
        }
        if (
            isset($this->_dataObject->data->exp_to) &&
            $this->_dataObject->data->exp_to != ""
        ) {
