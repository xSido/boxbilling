    ...
    private function _domainTLD($domain, $request)
    {
        $cmd = [
            ...
            "attributes" => [
                ...
                "services" => ["lookup", "premium", "suggestion"],
            ],
        ];
        ...
        if (
            ...
            $cmd["attributes"]["service_override"]["lookup"]["maximum"] =
                $this->_dataObject->data->maximum;
            $cmd["attributes"]["service_override"]["premium"]["maximum"] =
                $this->_dataObject->data->maximum;
            $cmd["attributes"]["service_override"]["suggestion"]["maximum"] =
                $this->_dataObject->data->maximum;
        }
        ...
        if (isset($arrayResult["attributes"])) {
            ...
            $this->resultRaw = [
                ...
                "premium" => $tempHold,
                "suggestion" =>
                    $arrayResult["attributes"]["suggestion"]["items"],
            ];
        } else {
