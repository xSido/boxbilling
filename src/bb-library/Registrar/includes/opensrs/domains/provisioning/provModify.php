...
class provModify extends openSRS_base
{
    ...
    private function _validateObject()
    {
        ...
        if (
            !isset($this->_dataObject->data->affect_domains) ||
            $this->_dataObject->data->affect_domains == ""
        ) {
            trigger_error(
                "oSRS Error - affect_domains is not defined.",
                E_USER_WARNING
            );
            $allPassed = false;
        }
        if (
            !isset($this->_dataObject->data->data) ||
            $this->_dataObject->data->data == ""
        ) {
            trigger_error(
                "oSRS Error - data variable that defines the modify type is not defined.",
                E_USER_WARNING
            );
            $allPassed = false;
        } else {
    ...
    private function _allCedInfoCheck()
    {
        ...
        if (
            !isset($this->_dataObject->data->ced_info) ||
            $this->_dataObject->data->ced_info == ""
        ) {
            trigger_error(
                "oSRS Error - change type is ced_info but ced_info is not defined.",
                E_USER_WARNING
            );
            $allCedInfo = false;
        }
        ...
        if (
            ...
            trigger_error(
                "oSRS Error - change type is ced_info but contact_type is not defined.",
                E_USER_WARNING
            );
            $allCedInfo = false;
        }
        if (
            ...
            trigger_error(
                "oSRS Error - change type is ced_info but id_number is not defined.",
                E_USER_WARNING
            );
            $allCedInfo = false;
        }
        if (
            ...
            trigger_error(
                "oSRS Error - change type is ced_info but legal_entity_type is not defined.",
                E_USER_WARNING
            );
            $allCedInfo = false;
        }
        if (
            ...
            trigger_error(
                "oSRS Error - change type is ced_info but locality_country is not defined.",
                E_USER_WARNING
            );
            $allCedInfo = false;
        }
        if (
            ...
            trigger_error(
                "oSRS Error - change type is ced_info but locality_state_prov is not defined.",
                E_USER_WARNING
            );
            $allCedInfo = false;
        }
    ...
    private function _allRspWhoisInfoCheck()
    {
        ...
        if (
            ...
            trigger_error(
                "oSRS Error - change type is change_rsp_whois_info but all is not defined.",
                E_USER_WARNING
            );
        ...
        if (
            ...
            trigger_error(
                "oSRS Error - change type is rsp_whois_info but flag is not defined.",
                E_USER_WARNING
            );
            $allRspWhoisInfo = false;
        }
    ...
    private function _allTrademarkCheck()
    {
        ...
        if (
            ...
            trigger_error(
                "oSRS Error - change type is trademark but trademark is not defined.",
                E_USER_WARNING
            );
    ...
    private function _allChangeIpsTagCheck()
    {
        ...
        if (
            ...
            trigger_error(
                "oSRS Error - change type is change_ips_tag but domain is not defined.",
                E_USER_WARNING
            );
        ...
        if (
            ...
            trigger_error(
                "oSRS Error - change type is change_ips_tag but gaining_registrar_tag is not defined.",
                E_USER_WARNING
            );
            $allChangeIpsTagInfo = false;
        }
    ...
    private function _allContactInfoCheck()
    {
        ...
        if (
            ...
            trigger_error(
                "oSRS Error - change type is contact_info but personal is not defined.",
                E_USER_WARNING
            );
        ...
        if (
            ...
            trigger_error(
                "oSRS Error - change type is contact_info but contact_type is not defined.",
                E_USER_WARNING
            );
            $allContactInfo = false;
        }
        ...
        for ($i = 0; $i < count($reqPers); $i++) {
            if ($this->_dataObject->personal->$reqPers[$i] == "") {
                trigger_error(
                    "oSRS Error - change type is contact_info but  " .
                        $reqPers[$i] .
                        " is not defined in personal.",
                    E_USER_WARNING
                );
                $allContactInfo = false;
            }
    ...
    private function _allDomainAuthInfoCheck()
    {
        ...
        if (
            ...
            trigger_error(
                "oSRS Error - data type is domain_auth_info but a domain_auth_info value is not defined.",
                E_USER_WARNING
            );
    ...
    private function _allExpireActionCheck()
    {
        ...
        if (
            ...
            trigger_error(
                "oSRS Error - data type is expire_action but auto_renew is not defined.",
                E_USER_WARNING
            );
        ...
        if (
            ...
            trigger_error(
                "oSRS Error - data type is expire_action but let_expire is not defined.",
                E_USER_WARNING
            );
            $allExpireActionInfo = false;
        }
    ...
    private function _allForwardingEmailCheck()
    {
        ...
        if (
            ...
            trigger_error(
                "oSRS Error - data type is forwarding_email but a forwarding_email is not defined.",
                E_USER_WARNING
            );
    ...
    private function _allNexusInfoCheck()
    {
        $allNexusInfo = true;
        if (
            !isset($this->_dataObject->data->nexus) ||
            $this->_dataObject->data->nexus == ""
        ) {
            trigger_error(
                "oSRS Error - data type is nexus_info but nexus is not defined.",
                E_USER_WARNING
            );
            $allNexusInfo = false;
        }
        if (
            ...
            trigger_error(
                "oSRS Error - data type is nexus_info but app_purpose is not defined.",
                E_USER_WARNING
            );
            $allNexusInfo = false;
        }
        if (
            ...
            trigger_error(
                "oSRS Error - data type is nexus_info but category is not defined.",
                E_USER_WARNING
            );
            $allNexusInfo = false;
        }
    ...
    private function _allParkpageStateCheck()
    {
        ...
        if (
            ...
            trigger_error(
                "oSRS Error - data type is parkpage_state but domain is not defined.",
                E_USER_WARNING
            );
        ...
        if (
            ...
            trigger_error(
                "oSRS Error - data type is parkpage_state but state is not defined.",
                E_USER_WARNING
            );
            $allParkPageStateInfo = false;
        }
    ...
    private function _allUKWhoisOptCheck()
    {
        ...
        if (
            ...
            trigger_error(
                "oSRS Error - change type is uk_whois_opt but reg_type is not defined.",
                E_USER_WARNING
            );
        ...
        if (
            ...
            trigger_error(
                "oSRS Error - change type is uk_whois_opt but uk_whois_opt is not defined.",
                E_USER_WARNING
            );
            $allUKWhoisOptInfo = false;
        }
    ...
    private function _allStatusCheck()
    {
        ...
        if (
            ...
            trigger_error(
                "oSRS Error - data type is status but lock_state is not defined.",
                E_USER_WARNING
            );
            $allStatusInfo = false;
        }
        if (
            ...
            trigger_error(
                "oSRS Error - data type is status but domain_name is not defined.",
                E_USER_WARNING
            );
            $allStatusInfo = false;
        }
    ...
    private function _allWhoisPrivacyStateCheck()
    {
        ...
        if (
            ...
            trigger_error(
                "oSRS Error - change type is whois_privacy_state but state is not defined.",
                E_USER_WARNING
            );
        ...
        switch ($this->_dataObject->data->data) {
            case "ced_info":
                ...
                if (
                    ...
                    $cmd["attributes"]["ced_info"]["contact_type"] =
                        $this->_dataObject->data->ced_info->contact_type;
                }
                if (
                    isset($this->_dataObject->data->ced_info->id_number) &&
                    ...
                    $cmd["attributes"]["ced_info"]["id_number"] =
                        $this->_dataObject->data->ced_info->id_number;
                }
                if (
                    ...
                    $cmd["attributes"]["ced_info"]["id_type"] =
                        $this->_dataObject->data->ced_info->id_type;
                }
                if (
                    ...
                    $cmd["attributes"]["ced_info"]["id_type_info"] =
                        $this->_dataObject->data->ced_info->id_type_info;
                }
                if (
                    isset(
                    ...
                    $cmd["attributes"]["ced_info"]["legal_entity_type"] =
                        $this->_dataObject->data->ced_info->legal_entity_type;
                }
                if (
                    isset(
                    ...
                    $cmd["attributes"]["ced_info"]["legal_entity_type_info"] =
                ...
                if (
                    ...
                    $cmd["attributes"]["ced_info"]["locality_city"] =
                        $this->_dataObject->data->ced_info->locality_city;
                }
                if (
                    isset(
                    ...
                    $cmd["attributes"]["ced_info"]["locality_country"] =
                        $this->_dataObject->data->ced_info->locality_country;
                }
                if (
                    isset(
                    ...
                    $cmd["attributes"]["ced_info"]["localicty_state_prov"] =
                        $this->_dataObject->data->ced_info->locality_state_prov;
                }
            ...
            case "change_ips_tag":
                ...
                if (
                    ...
                    $cmd["attributes"]["gaining_registrar_tag"] =
                        $this->_dataObject->data->gaining_registrar_tag;
                }
                if (
            ...
            case "domain_auth_info":
                ...
                if (
                    ...
                    $cmd["attributes"]["domain_auth_info"] =
                        $this->_dataObject->data->domain_auth_info;
                }
                break;
            case "expire_action":
            ...
            case "forwarding_email":
                if (
                    ...
                    $cmd["attributes"]["forwarding_email"] =
                        $this->_dataObject->data->forwarding_email;
                }
                break;
            case "nexus_info":
                ...
                if (
                    ...
                    $cmd["attributes"]["nexus"]["app_purpose"] =
                        $this->_dataObject->data->nexus->app_purpose;
                }
                if (
                    isset($this->_dataObject->data->nexus->category) &&
                ...
                if (
                    ...
                    $cmd["attributes"]["nexus"]["validator"] =
                        $this->_dataObject->data->nexus->validator;
                }
                break;
            case "parkpage_state":
            ...
            case "uk_whois_opt":
                ...
                if (
                    ...
                    $cmd["attributes"]["uk_affect_domains"] =
                        $this->_dataObject->data->uk_affect_domains;
                }
                if (
                    isset($this->_dataObject->data->uk_whois_opt) &&
