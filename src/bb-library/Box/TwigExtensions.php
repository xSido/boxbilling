...
class Box_TwigExtensions extends Twig\Extension\AbstractExtension implements
    \Box\InjectionAwareInterface
{
    ...
    {
        return [
            "alink" => new Twig\TwigFilter(
                "alink",
                [$this, "twig_bb_admin_link_filter"],
                ["is_safe" => ["html"]]
            ),
            "link" => new Twig\TwigFilter(
                "link",
                [$this, "twig_bb_client_link_filter"],
                ["is_safe" => ["html"]]
            ),
            "gravatar" => new Twig\TwigFilter(
                "gravatar",
                "twig_gravatar_filter"
            ),
            "markdown" => new Twig\TwigFilter(
                "markdown",
                "twig_markdown_filter",
                ["needs_environment" => true, "is_safe" => ["html"]]
            ),
            "truncate" => new Twig\TwigFilter(
                "truncate",
                "twig_truncate_filter",
                ["needs_environment" => true]
            ),
            "timeago" => new Twig\TwigFilter("timeago", "twig_timeago_filter"),
            "daysleft" => new Twig\TwigFilter(
                "daysleft",
                "twig_daysleft_filter"
            ),
            "size" => new Twig\TwigFilter("size", "twig_size_filter"),
            "ipcountryname" => new Twig\TwigFilter("ipcountryname", [
                $this,
                "twig_ipcountryname_filter",
            ]),
            "number" => new Twig\TwigFilter("number", "twig_number_filter"),
            "period_title" => new Twig\TwigFilter(
                "period_title",
                "twig_period_title",
                ["needs_environment" => true, "is_safe" => ["html"]]
            ),
            "autolink" => new Twig\TwigFilter(
                "autolink",
                "twig_autolink_filter"
            ),
            "bbmd" => new Twig\TwigFilter("bbmd", "twig_bbmd_filter", [
                "needs_environment" => true,
                "is_safe" => ["html"],
            ]),

            "bb_date" => new Twig\TwigFilter("bb_date", [
                $this,
                "twig_bb_date",
            ]),
            "bb_datetime" => new Twig\TwigFilter("bb_datetime", [
                $this,
                "twig_bb_datetime",
            ]),

            "img_tag" => new Twig\TwigFilter("img_tag", "twig_img_tag", [
                "needs_environment" => false,
                "is_safe" => ["html"],
            ]),
            "script_tag" => new Twig\TwigFilter(
                "script_tag",
                "twig_script_tag",
                ["needs_environment" => false, "is_safe" => ["html"]]
            ),
            "stylesheet_tag" => new Twig\TwigFilter(
                "stylesheet_tag",
                "twig_stylesheet_tag",
                ["needs_environment" => false, "is_safe" => ["html"]]
            ),

            "mod_asset_url" => new Twig\TwigFilter(
                "mod_asset_url",
                "twig_mod_asset_url"
            ),
            "asset_url" => new Twig\TwigFilter("asset_url", "twig_asset_url", [
                "needs_environment" => true,
                "is_safe" => ["html"],
            ]),

            "money" => new Twig\TwigFilter("money", "twig_money", [
                "needs_environment" => true,
                "is_safe" => ["html"],
            ]),
            "money_without_currency" => new Twig\TwigFilter(
                "money_without_currency",
                "twig_money_without_currency",
                ["needs_environment" => true, "is_safe" => ["html"]]
            ),
            "money_convert" => new Twig\TwigFilter(
                "money_convert",
                "twig_money_convert",
                ["needs_environment" => true, "is_safe" => ["html"]]
            ),
            "money_convert_without_currency" => new Twig\TwigFilter(
                "money_convert_without_currency",
                ["needs_environment" => true, "is_safe" => ["html"]]
            ),
        ];
    }
...
function twig_money_convert(Twig\Environment $env, $price, $currency = null)
{
    ...
    return $api_guest->currency_format([
        "price" => $price,
        "code" => $currency,
        "convert" => true,
    ]);
...
function money_convert_without_currency(
...
function twig_money_without_currency(
    Twig\Environment $env,
    $price,
    $currency = null
) {
...
{
    return sprintf(
        '<link rel="stylesheet" type="text/css" href="%s?v=%s" media="%s" />',
        $path,
        Box_Version::VERSION,
        $media
    );
...
function twig_markdown_filter(Twig\Environment $env, $value)
{
    ...
    $result = $markdownParser->transform(
