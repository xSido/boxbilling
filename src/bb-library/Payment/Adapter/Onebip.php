...
class Payment_Adapter_Onebip extends Payment_AdapterAbstract
{
    ...
    public static function getConfig()
    {
        return [
            ...
            "description" =>
                "Onebip is a system that allows mobile phone subscribers to transfer pre-paid or post-paid credit from their SIM card to another use.",
            "form" => [
                "username" => [
                    "email",
                    [
                        "label" =>
                            "The email address associated to your Onebip account.",
                    ],
                ],
                "api_key" => [
                    "password",
                    [
                        "label" =>
                            "OneBip API key. Stored in OneBip account settings. Used to validate payment notification",
                    ],
                ],
                "logo_url" => [
                    "text",
                    [
                        "label" =>
                            "URL to your company logo. The URL of the 360x45-pixel image displayed as your logo in the upper left corner of the Onebip payment pages",
                    ],
                ],
            ],
        ];
