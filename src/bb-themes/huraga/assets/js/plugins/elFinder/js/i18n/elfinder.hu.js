...
if (
  ...
  elFinder.prototype.i18.hu = {
    ...
    messages: {
      ...
      errJqui:
        'Hibás jQuery UI konfiguráció. A "selectable", "draggable" és a "droppable" komponensek szükségesek.',
      ...
      confirmRm:
        "Valóban törölni akarja a kijelölt adatokat?<br/>Ez később nem fordítható vissza!",
