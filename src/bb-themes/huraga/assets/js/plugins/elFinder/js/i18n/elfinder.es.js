...
if (
  ...
  elFinder.prototype.i18.es = {
    ...
    messages: {
      ...
      errJqui:
        "Configuración no válida de jQuery UI. deben estar incluidos los componentes selectable, draggable y droppable.",
      errNode: "elFinder necesita crear elementos DOM.",
      errURL:
        "Configuración no válida de elFinder! La opción URL no está configurada.",
      ...
      errLocked:
        '"$1" está bloqueado y no puede ser renombrado, movido o borrado.',
      ...
      errPopup:
        "El navegador impide abrir nuevas ventanas. Puede activarlo en las opciones del navegador.",
      ...
      errNoArchive:
        "El archivo no es de tipo archivo o es de un tipo no soportado.",
      errCmdNoSupport: "El backend no soporta este comando.",
      errReplByChild:
        "La carpeta “$1” no puede ser reemplazada por un elemento contenido en ella.",
      errArcSymlinks:
        "Por razones de seguridad no se pueden descomprimir archivos que contengan symlinks.",
      ...
      confirmRm:
        "¿Está seguro de querer eliminar archivos?<br/>Esto no tiene vuelta atrás!",
