...
if (
  ...
  elFinder.prototype.i18.pl = {
    ...
    messages: {
      ...
      errJqui:
        "Niepoprawna konfiguracja jQuery UI. Muszą być zawarte komponenty selectable, draggable i droppable.",
      ...
      errLocked:
        '"$1" jest zablokowany i nie może zostać zmieniony, przeniesiony lub usunięty.',
      ...
      errPopup:
        "Przeglądarka zablokowała otwarcie nowego okna. Aby otworzyć plik, zmień ustawienia przeglądarki.",
      ...
      errReplByChild:
        'Nie można zastąpić katalogu "$1" elementem w nim zawartym',
      errArcSymlinks:
        "Ze względów bezpieczeństwa rozpakowywanie archiwów zawierających dowiązania symboliczne (symlinks) jest niedozwolone.",
      ...
      confirmRm:
        "Czy na pewno chcesz usunąć pliki?<br/>Tej operacji nie można cofnąć!",
