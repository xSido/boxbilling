...
if (
  ...
  elFinder.prototype.i18.cs = {
    ...
    messages: {
      ...
      errJqui:
        "Nedostačující konfigurace jQuery UI. Musí být zahrnuty komponenty Selectable, draggable a droppable.",
      ...
      errLocked:
        '"$1" je uzamčený a nemůže být přejmenován, přesunut nebo smazán.',
      ...
      errPopup:
        "Prohlížeč zabránil otevření vyskakovacího okna. K otevření souboru, povolte vyskakovací okno v prohlížeči.",
      ...
      errReplByChild:
        'Složka "$1" nemůže být nahrazena souborem, který sama obsahuje.',
      errArcSymlinks:
        "Z bezpečnostních důvodů je zakázáno rozbalit archívy obsahující symlinky.",
      ...
      confirmRm:
        "Opravdu chcete odstranit tyto soubory?<br/>Změna nelze vrátit!",
