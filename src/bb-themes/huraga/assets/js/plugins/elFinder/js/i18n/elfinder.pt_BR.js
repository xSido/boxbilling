...
if (
  ...
  elFinder.prototype.i18.pt_BR = {
    ...
    messages: {
      ...
      errJqui:
        "Configuração inválida do JQuery UI. Verifique os componentes selectable, draggable e droppable incluidos.",
      errNode: "elFinder requer um elemento DOM para ser criado.",
      errURL:
        "Configuração inválida do elFinder! Você deve setar a opção da URL.",
      ...
      errLocked:
        '"$1" está bloqueado e não pode ser renomeado, movido ou removido.',
      ...
      errPopup:
        "Navegador impediu abertura da janela popup, Para abrir o arquivo desabilite está  opção no navegador.",
      ...
      confirmRm:
        "Você tem certeza que quer remover os arquivos?<br />Isto não pode ser desfeito!",
