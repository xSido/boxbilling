...
if (
  ...
  elFinder.prototype.i18.ca = {
    ...
    messages: {
      ...
      errJqui:
        'La configuració de jQuery UI no és vàlida. S\'han d\'incloure els components "selectable", "draggable" i "droppable".',
      errNode: "elFinder necessita crear elements DOM.",
      errURL:
        "La configuració de l'elFinder no és vàlida! L'opció URL no està configurada.",
      ...
      errLocked:
        '"$1" està bloquejat i no podeu canviar-li el nom, moure-lo ni suprimir-lo.',
      ...
      errPopup:
        "El navegador ha evitat obrir una finestra emergent. Autoritzeu-la per obrir el fitxer.",
      ...
      errReplByChild:
        "No es pot reemplaçar la carpeta “$1” per un element que conté.",
      errArcSymlinks:
        "Per raons de seguretat, no es permet extreure arxius que contenen enllaços simbòlics.",
      errArcMaxSize:
        "Els fitxers de l'arxiu excedeixen la mida màxima permesa.",
