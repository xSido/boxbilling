...
if (
  ...
  elFinder.prototype.i18.ar = {
    ...
    messages: {
      ...
      errJqui:
        "إعدادات jQuery UI غير كاملة الرجاء التأكد من وجود كل من selectable, draggable and droppable",
      ...
      errPopup:
        "يمنعني المتصفح من إنشاء نافذة منبثقة , الرجاء تعديل الخيارات الخاصة  من إعدادات المتصفح ",
      ...
      errArcSymlinks:
        "For security reason denied to unpack archives contains symlinks.",
      ...
      confirmRm:
        "هل انت متأكد من انك تريد الحذف<br/>لا يمكن التراجع عن هذه العملية ",
