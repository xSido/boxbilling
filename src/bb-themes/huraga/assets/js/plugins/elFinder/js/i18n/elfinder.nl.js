...
if (
  ...
  elFinder.prototype.i18.nl = {
    ...
    messages: {
      ...
      errJqui:
        "Ongeldige jQuery UI configuratie. Selectable, draggable en droppable componenten moeten aanwezig zijn.",
      ...
      errLocked:
        '"$1" is vergrendeld en kan niet hernoemd, verplaats of verwijderd worden.',
      ...
      errPopup:
        "De browser heeft voorkomen dat de pop-up is geopend. Pas de browser instellingen aan om de popup te kunnen openen.",
      ...
      errReplByChild:
        'De map "$1" kan niet vervangen worden door een item uit die map.',
      errArcSymlinks:
        "Om veiligheidsredenen kan een bestand met symlinks niet worden uitgepakt .",
      ...
      confirmRm:
        "Weet u zeker dat u deze bestanden wil verwijderen?<br/>Deze actie kan niet ongedaan gemaakt worden!",
