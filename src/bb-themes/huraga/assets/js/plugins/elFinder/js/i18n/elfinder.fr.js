...
if (
  elFinder &&
  elFinder.prototype &&
  typeof elFinder.prototype.i18 == "object"
) {
  elFinder.prototype.i18.fr = {
    ...
    messages: {
      ...
      errJqui:
        "Mauvaise configuration de jQuery UI. Les composants Selectable, draggable et droppable doivent être inclus.",
      errNode: "elFinder requiert que l'élément DOM ait été créé.",
      errURL:
        "Mauvaise configuration d'elFinder ! L'option URL na pas été définie.",
      ...
      errPopup:
        "Le navigateur web a empêché l'ouverture d'une fenêtre \"popup\". Pour ouvrir le fichier, modifiez les options du navigateur web.",
      ...
      errNoArchive:
        "Le fichier n'est pas une archive, ou c'est un type d'archive non supporté.",
      errCmdNoSupport: "Le Backend ne prend pas en charge cette commande.",
      errReplByChild:
        "Le dossier “$1” ne peut pas être remplacé par un élément qu'il contient.",
      errArcSymlinks:
        "Par mesure de sécurité, il est défendu d'extraire une archive contenant des liens symboliques.",
      errArcMaxSize:
        "Les fichiers de l'archive excèdent la taille maximale autorisée.",
      ...
      confirmRm:
        "Êtes-vous certain de vouloir supprimer les fichiers?<br/>Cela ne peut être annulé!",
