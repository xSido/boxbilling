 ...
 * Build: http://modernizr.com/download/#-borderradius-boxshadow-opacity-rgba-textshadow-cssgradients-shiv-cssclasses-testprop-testallprops-prefixes-domprefixes-load
 */
(window.Modernizr = (function (a, b, c) {
  ...
  !A(w, "undefined") && !A(w.call, "undefined")
    ...
    (q.rgba = function () {
      return (
        y("background-color:rgba(150,255,150,.5)"), B(j.backgroundColor, "rgba")
      );
    }),
    ...
    (q.cssgradients = function () {
      ...
      return (
        ...
        B(j.backgroundImage, "gradient")
      );
    });
  for (var F in q)
    x(q, F) &&
      ((v = F.toLowerCase()), (e[v] = q[F]()), t.push((e[v] ? "" : "no-") + v));
  return (
