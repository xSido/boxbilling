...
class Client implements \Box\InjectionAwareInterface
{
    ...
    public function register(\Box_App &$app)
    {
        $app->get(
            ...
            "get_profile",
            [],
            "\Box\Mod\Client\Controller\Client"
        );
        $app->get(
            "/balance",
            "get_balance",
        ...
        $app->get(
            ...
            "get_emails",
            [],
            "\Box\Mod\Email\Controller\Client"
        );
        $app->get(
            "/banklink/:hash/:id",
            "get_banklink",
            ["id" => "[0-9]+", "hash" => "[a-z0-9]+"],
            "\Box\Mod\Invoice\Controller\Client"
        );
        ...
        $app->get(
            ...
            "get_news_item",
            ["slug" => "[a-z0-9-]+"],
            "\Box\Mod\News\Controller\Client"
        );
        $app->get(
            "/service",
            "get_orders",
        ...
        $app->get(
            ...
            "get_contact_us",
            [],
            "\Box\Mod\Support\Controller\Client"
        );
        $app->get(
            "/contact-us/conversation/:hash",
            "get_contact_us_conversation",
            ["hash" => "[a-z0-9]+"],
            "\Box\Mod\Support\Controller\Client"
        );
