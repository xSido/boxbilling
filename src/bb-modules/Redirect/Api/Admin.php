...
class Admin extends \Api_Abstract
{
    ...
    public function create($data)
    {
        ...
        $bean->meta_key = trim(
            htmlspecialchars($data["path"], ENT_QUOTES | ENT_HTML5, "UTF-8"),
            "/"
        );
        $bean->meta_value = trim(
            htmlspecialchars($data["target"], ENT_QUOTES | ENT_HTML5, "UTF-8"),
            "/"
        );
    ...
    public function update($data)
    {
        ...
        $bean->meta_key = trim(
            htmlspecialchars(
                $this->di["array_get"]($data, "path", $bean->meta_key),
        ...
        $bean->meta_value = trim(
            htmlspecialchars(
                $this->di["array_get"]($data, "target", $bean->meta_value),
                ENT_QUOTES | ENT_HTML5,
                "UTF-8"
            ),
            "/"
