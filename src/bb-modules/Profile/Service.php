...
class Service implements InjectionAwareInterface
{
    ...
    public function changeAdminPassword(\Model_Admin $admin, $new_password)
    {
        ...
        $this->di["events_manager"]->fire([
            "event" => "onBeforeAdminStaffProfilePasswordChange",
            "params" => $event_params,
        ]);
        ...
        $event_params["id"] = $admin->id;
        $this->di["events_manager"]->fire([
            "event" => "onAfterAdminStaffProfilePasswordChange",
            "params" => $event_params,
        ]);
    ...
    public function generateNewApiKey(\Model_Admin $admin)
    {
        ...
        $event_params["id"] = $admin->id;
        $this->di["events_manager"]->fire([
            "event" => "onBeforeAdminStaffApiKeyChange",
            "params" => $event_params,
        ]);
        ...
        $this->di["events_manager"]->fire([
            "event" => "onAfterAdminStaffApiKeyChange",
            "params" => $event_params,
        ]);
    ...
    public function updateAdmin(\Model_Admin $admin, array $data)
    {
        ...
        $event_params["id"] = $admin->id;
        $this->di["events_manager"]->fire([
            "event" => "onAfterAdminStaffProfileUpdate",
            "params" => $event_params,
        ]);
    ...
    public function updateClient(\Model_Client $client, array $data = [])
    {
        ...
        $this->di["events_manager"]->fire([
            "event" => "onBeforeClientProfileUpdate",
            "params" => $event_params,
        ]);
        ...
        $client->phone_cc = $this->di["array_get"](
            $data,
            "phone_cc",
            $client->phone_cc
        );
        ...
        $this->di["events_manager"]->fire([
            "event" => "onAfterClientProfileUpdate",
            "params" => ["id" => $client->id],
        ]);
    ...
    public function changeClientPassword(\Model_Client $client, $password)
    {
        ...
        $event_params["id"] = $client->id;
        $this->di["events_manager"]->fire([
            "event" => "onBeforeClientProfilePasswordChange",
            "params" => $event_params,
        ]);
        ...
        $this->di["events_manager"]->fire([
            "event" => "onAfterClientProfilePasswordChange",
            "params" => ["id" => $client->id],
        ]);
