...
class Admin extends \Api_Abstract
{
    ...
    public function update_core($data)
    {
        ...
        $this->di["logger"]->info(
            "Updated BoxBilling from %s to %s",
            \Box_Version::VERSION,
            $new_version
        );
        return true;
    ...
    public function deactivate($data)
    {
        ...
        $this->di["events_manager"]->fire([
            "event" => "onBeforeAdminDeactivateExtension",
            "params" => ["id" => $ext->id],
        ]);
        ...
        $this->di["events_manager"]->fire([
            "event" => "onAfterAdminDeactivateExtension",
    ...
    public function uninstall($data)
    {
        $ext = $this->_getExtension($data);
        $this->di["events_manager"]->fire([
            "event" => "onBeforeAdminUninstallExtension",
            "params" => ["id" => $ext->id],
        ]);
        ...
        $this->di["events_manager"]->fire([
            "event" => "onAfterAdminUninstallExtension",
            "params" => ["id" => $ext->id],
        ]);
        return true;
    }
    ...
    public function install($data)
    {
        ...
        $this->di["events_manager"]->fire([
            "event" => "onBeforeAdminInstallExtension",
            "params" => $data,
        ]);
        ...
        $this->di["events_manager"]->fire([
            "event" => "onAfterAdminInstallExtension",
            "params" => $data,
        ]);
        return [
            "success" => true,
