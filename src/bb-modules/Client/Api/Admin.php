...
class Admin extends \Api_Abstract
{
    ...
    public function delete($data)
    {
        ...
        $this->di["events_manager"]->fire([
            "event" => "onBeforeAdminClientDelete",
            "params" => ["id" => $model->id],
        ]);
        ...
        $this->di["events_manager"]->fire([
            "event" => "onAfterAdminClientDelete",
            "params" => ["id" => $id],
        ]);
    ...
    public function update($data = [])
    {
        ...
        $this->di["validator"]->isBirthdayValid(
            $this->di["array_get"]($data, "birthday")
        );

        if (
            $this->di["array_get"]($data, "currency") &&
            $service->canChangeCurrency(
                $client,
                $this->di["array_get"]($data, "currency")
            )
        ) {
            $client->currency = $this->di["array_get"](
                $data,
                "currency",
                $client->currency
            );
        ...
        $this->di["events_manager"]->fire([
            "event" => "onBeforeAdminClientUpdate",
            "params" => $data,
        ]);
        ...
        $client->first_name = $this->di["array_get"](
            $data,
            "first_name",
            $client->first_name
        );
        $client->last_name = $this->di["array_get"](
            $data,
            "last_name",
            $client->last_name
        );
        $client->aid = $this->di["array_get"]($data, "aid", $client->aid);
        $client->gender = $this->di["array_get"](
            $data,
            "gender",
            $client->gender
        );
        $client->birthday = $this->di["array_get"](
            $data,
            "birthday",
            $client->birthday
        );
        $client->company = $this->di["array_get"](
            $data,
            "company",
            $client->company
        );
        $client->company_vat = $this->di["array_get"](
            $data,
            "company_vat",
            $client->company_vat
        );
        $client->address_1 = $this->di["array_get"](
            $data,
            "address_1",
            $client->address_1
        );
        $client->address_2 = $this->di["array_get"](
            $data,
            "address_2",
            $client->address_2
        );
        $client->phone = $this->di["array_get"]($data, "phone", $client->phone);
        $client->document_type = $this->di["array_get"](
            $data,
            "document_type",
            $client->document_type
        );
        $client->document_nr = $this->di["array_get"](
            $data,
            "document_nr",
            $client->document_nr
        );
        $client->notes = $this->di["array_get"]($data, "notes", $client->notes);
        $client->country = $this->di["array_get"](
            $data,
            "country",
            $client->country
        );
        $client->postcode = $this->di["array_get"](
            $data,
            "postcode",
            $client->postcode
        );
        ...
        $client->status = $this->di["array_get"](
            $data,
            "status",
            $client->status
        );
        $client->email_approved = $this->di["array_get"](
            $data,
            "email_approved",
            $client->email_approved
        );
        $client->tax_exempt = $this->di["array_get"](
            $data,
            "tax_exempt",
            $client->tax_exempt
        );
        $client->created_at = $this->di["array_get"](
            $data,
            "created_at",
            $client->created_at
        );

        $client->custom_1 = $this->di["array_get"](
            $data,
            "custom_1",
            $client->custom_1
        );
        $client->custom_2 = $this->di["array_get"](
            $data,
            "custom_2",
            $client->custom_2
        );
        $client->custom_3 = $this->di["array_get"](
            $data,
            "custom_3",
            $client->custom_3
        );
        $client->custom_4 = $this->di["array_get"](
            $data,
            "custom_4",
            $client->custom_4
        );
        $client->custom_5 = $this->di["array_get"](
            $data,
            "custom_5",
            $client->custom_5
        );
        $client->custom_6 = $this->di["array_get"](
            $data,
            "custom_6",
            $client->custom_6
        );
        $client->custom_7 = $this->di["array_get"](
            $data,
            "custom_7",
            $client->custom_7
        );
        $client->custom_8 = $this->di["array_get"](
            $data,
            "custom_8",
            $client->custom_8
        );
        $client->custom_9 = $this->di["array_get"](
            $data,
            "custom_9",
            $client->custom_9
        );
        $client->custom_10 = $this->di["array_get"](
            $data,
            "custom_10",
            $client->custom_10
        );

        $client->client_group_id = $this->di["array_get"](
            $data,
            "group_id",
        ...
        $this->di["events_manager"]->fire([
            "event" => "onAfterAdminClientUpdate",
            "params" => ["id" => $client->id],
        ]);
    ...
    public function change_password($data)
    {
        ...
        $this->di["events_manager"]->fire([
            "event" => "onBeforeAdminClientPasswordChange",
            "params" => $data,
        ]);
        ...
        $this->di["events_manager"]->fire([
            "event" => "onAfterAdminClientPasswordChange",
    ...
    public function balance_delete($data)
    {
        ...
        $this->di["logger"]->info(
            "Removed line %s from client #%s balance for %s",
            $id,
            $client_id,
            $amount
        );
    ...
    public function batch_expire_password_reminders()
    {
        ...
        $this->di["logger"]->info(
            "Executed action to delete expired clients password reminders"
        );
        return true;
    }
