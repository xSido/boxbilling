module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    clean: {
      css: {
        src: ["src/bb-themes/admin_default/css/min-temp.css"],
      },
      js: {
        src: ["src/bb-themes/admin_default/js/boxbilling.js"],
      },
    },
    ...
    cssmin: {
      target: {
        files: [
          {
            "src/bb-themes/admin_default/css/min.css": [
    ...
    uglify: {
      js: {
        files: {
          "src/bb-themes/admin_default/js/boxbilling.min.js": [
