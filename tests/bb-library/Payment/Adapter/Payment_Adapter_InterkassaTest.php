...
class Payment_Adapter_InterkassaTest extends PHPUnit\Framework\TestCase
{
    ...
    public function testgetType()
    {
        $adapterMock = $this->getMockBuilder("\Payment_Adapter_Interkassa")
            ...
            ->getMock();
        $this->assertEquals(
            Payment_AdapterAbstract::TYPE_FORM,
            $adapterMock->getType()
        );
    }
    ...
    public function testsinglePayment()
    {
        ...
        $paymentInvoiceMock = $this->getMockBuilder(
            "Payment_Invoice"
        )->getMock();
        $paymentInvoiceMock->expects($this->atLeastOnce())->method("getId");
        $paymentInvoiceMock->expects($this->atLeastOnce())->method("getTotal");
        $paymentInvoiceMock->expects($this->atLeastOnce())->method("getTitle");
        $paymentInvoiceMock
            ->expects($this->atLeastOnce())
            ->method("getCurrency");
        $paymentInvoiceMock->expects($this->atLeastOnce())->method("getTotal");
    ...
    public function testprocessTransaction_Success()
    {
        $adapterMock = $this->getMockBuilder("\Payment_Adapter_Interkassa")
            ->disableOriginalConstructor()
            ->setMethods(["isIpnValid", "isIpnDuplicate"])
            ->getMock();
        ...
        $clientServiceMock->expects($this->atLeastOnce())->method("addFunds");
