...
class Box_RequestTest extends PHPUnit\Framework\TestCase
{
    ...
    public function testPut()
    {
        ...
        $this->assertEquals(["example" => "1", "foo" => "bar"], $full_request);
    ...
    public function testGetMethod()
    {
        ...
        $request
            ->expects($this->atLeastOnce())
            ->method("getServer")
            ->will($this->returnValueMap([["REQUEST_METHOD", "POST"]]));
    ...
    public function testHeader()
    {
        $input = [
            ...
            "Accept-Language" =>
                "en-US,en;q=0.8,fr;q=0.6,id;q=0.4,lt;q=0.2,ms;q=0.2,nl;q=0.2,pl;q=0.2,pt;q=0.2,ru;q=0.2,es;q=0.2,nb;q=0.2,ro;q=0.2",
        ];
    ...
    public function testIsMethods()
    {
        ...
        $this->assertTrue($request->isMethod(["POST", "GET"]));
        $this->assertFalse($request->isMethod(["POST", "GET"]));
    }
        ...
        $request
            ...
            ->will(
                $this->onConsecutiveCalls(
                    $this->returnValueMap([["HTTPS", "1"], ["HTTPS", null]])
                )
            );
    ...
    public function testGetJsonRawBody()
    {
        ...
        $this->assertEquals(["example" => 1], $request->getJsonRawBody());
        try {
