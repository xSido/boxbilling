...
class Api_Admin_FormbuilderTest extends BBDbApiTestCase
{
    ...
    public function testFormExceptions()
    {
        ...
        try {
            $this->api_admin->formbuilder_create_form([
                "title" => "Form title",
                "style" => "not existing style",
            ]);
        } catch (Box_Exception $e) {
        }
        try {
        ...
        try {
            $this->api_admin->formbuilder_add_field(["id" => 1000000000]);
            $this->fail("An expected exception has not been raised.");
        } catch (Box_Exception $e) {
        }
        try {
        ...
        try {
            $this->api_admin->formbuilder_get_field(["id" => 1000000]);
            $this->fail("An expected exception has not been raised.");
        } catch (Box_Exception $e) {
        }
        ...
        try {
            $this->api_admin->formbuilder_update_field([
                "id" => 3,
                "description" => "This is very awesome description.",
                "name" => "",
            ]);
            $this->fail("An expected exception has not been raised.");
        } catch (Box_Exception $e) {
    ...
    {
        $fieldId = $this->api_admin->formbuilder_add_field([
            "form_id" => 1,
            "type" => "text",
        ]);
        ...
        $test = $this->api_admin->formbuilder_add_field([
            ...
            "readonly" => 0,
            "options" => [
                "0" => "First json on create",
                "2" => "Second json on create",
            ],
            "show_initial" => "initial",
            "show_middle" => "middle",
            "show_prefix" => "prefix",
    ...
    {
        $fields_before = count(
            $this->api_admin->formbuilder_get_form_fields(["form_id" => 1])
        );
    ...
    public function testCopyForm()
    {
        $test = $this->api_admin->formbuilder_add_field([
            ...
            "readonly" => 0,
            "options" => [
                "0" => "First oneon create",
                "2" => "second jsonon create",
            ],
            "show_initial" => "a",
            "show_middle" => "middle",
            "show_prefix" => "prefix",
