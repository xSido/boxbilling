...
class Api_Admin_OrderTest extends BBDbApiTestCase
{
    ...
    public function testOrdersStatuses($id)
    {
        ...
        $bool = $this->api_admin->order_update([
            "id" => 1,
    ...
    public function testOrderExpiration()
    {
        ...
        $this->assertEquals(
            2,
            date("Y", strtotime($oa["expires_at"])) -
                date("Y", strtotime($ob["expires_at"]))
        );
    }
    ...
    public function testOrderExpiration_SettingFromToday()
    {
        ...
        $this->assertEquals(
            $expectedExpireDate,
            date("Y-m-d", strtotime($order["expires_at"]))
        );
    }
    ...
    public function testDomainOrderExpiration()
    {
        ...
        $this->assertTrue(
            ...
            "Domain Order expiration date was not set after activation"
        );
    }
    ...
    public function testOrderBatchDelete()
    {
        ...
        $result = $this->api_admin->order_batch_delete([
            "ids" => $ids,
            "delete_addons" => true,
        ]);
        $array = $this->api_admin->order_get_list([]);
