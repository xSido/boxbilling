...
class Box_Mod_Invoice_ServiceTest extends BBDbApiTestCase
{
    ...
    public function testonAfterAdminCronRun()
    {
        ...
        $sql =
            "SELECT 1 FROM invoice WHERE status = 'unpaid' AND DATEDIFF(NOW(), due_at) > :days";
    ...
    {
        $invoiceItems = $this->di["mod_service"](
            "Invoice",
            "InvoiceItem"
        )->getAllNotExecutePaidItems();
