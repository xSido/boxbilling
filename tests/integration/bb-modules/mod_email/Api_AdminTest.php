...
class Api_AdminTest extends BBDbApiTestCase
{
    ...
    public function testTemplateGeneralSend()
    {
        ...
        $params["default_template"] =
            'Hello, message from {{ admin.client_get({"id":client_id}).first_name }}, {{subject}}';
    ...
    public function testTemplate_populateVariables()
    {
        ...
        $this->assertTrue(
            strpos($emailModel->subject, $clientModel->first_name) !== false,
            "Template variables were not populated"
        );
    }
