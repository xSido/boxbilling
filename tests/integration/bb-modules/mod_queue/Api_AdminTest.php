...
class Box_Mod_Queue_Api_AdminTest extends BBModTestCase
{
    ...
    {
        $int = $this->api_admin->queue_message_add([
            "queue" => "phpunit",
            "mod" => "queue",
            "handler" => "dummy",
            "params" => "value",
        ...
        $bool = $this->api_admin->queue_message_delete(["id" => $int]);
        $this->assertTrue($bool);

        $array = $this->api_admin->queue_get(["queue" => "phpunit2"]);
        ...
        $bool = $this->api_admin->queue_execute(["queue" => "phpunit"]);
        $this->assertTrue($bool);
    }
    ...
    public function testLater()
    {
        ...
        $int = $this->api_admin->queue_message_add([
            ...
            "mod" => "queue",
            "handler" => "dummy",
            "execute_at" => date("Y-m-d H:i:s", strtotime("+10 seconds")),
            "params" => "later",
        ]);
        $this->assertIsInt($int);
