...
class AdminTest extends \BBTestCase
{
    ...
    public function testlog()
    {
        ...
        $activity = new \Box\Mod\Activity\Api\Admin();
        $activity->setDi($di);
        $result = $activity->log(["m" => "hello message"]);
    ...
    {
        $service = $this->getMockBuilder("\Box\Mod\Activity\Service")
            ->setMethods(["logEmail"])
            ->getMock();
        $service
            ->expects($this->atLeastOnce())
    ...
    public function testlog_delete()
    {
        ...
        $databaseMock->expects($this->atLeastOnce())->method("trash");
    ...
    {
        $activityMock = $this->getMockBuilder("\Box\Mod\Activity\Api\Admin")
            ->setMethods(["log_delete"])
            ->getMock();
        $activityMock
            ->expects($this->atLeastOnce())
            ->method("log_delete")
