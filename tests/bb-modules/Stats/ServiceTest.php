...
class ServiceTest extends \BBTestCase
{
    ...
    {
        $pdoStatmentMock = $this->getMockBuilder(
            "\Box\Mod\Stats\PdoStatmentsMock"
        )->getMock();
        $pdoStatmentMock->expects($this->atLeastOnce())->method("execute");
        ...
        $pdoStatmentMock->expects($this->atLeastOnce())->method("fetchColumn");
