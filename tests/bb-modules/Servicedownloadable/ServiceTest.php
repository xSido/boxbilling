...
class ServiceTest extends \BBTestCase
{
    ...
    public function testupdateProductFile()
    {
        ...
        $this->service->setDi($di);
        $result = $this->service->updateProductFile(
            $serviceDownloadableModel,
            $orderModel
        );
        $this->assertIsBool($result);
        $this->assertTrue($result);
    ...
    public function testupdateProductFileFileNotUploaded()
    {
        ...
        $this->expectException(\Box_Exception::class);
        $this->expectExceptionMessage("Error uploading file");
        $this->service->updateProductFile(
            $serviceDownloadableModel,
            $orderModel
        );
    }
    ...
    public function testsendFile()
    {
        ...
        $filePath =
            "path/to/location" . md5($serviceDownloadableModel->filename);
    ...
    public function testsendFileFileDoesNotExists()
    {
        ...
        $toolsMock = $this->getMockBuilder("\Box_Tools")->getMock();
        $toolsMock->expects($this->atLeastOnce())->method("fileExists");
