...
class ServiceTest extends \BBTestCase
{
    ...
    public function testhasPermissionRoleStaffWithEmptyPerms()
    {
        ...
        $serviceMock->expects($this->atLeastOnce())->method("getPermissions");
    ...
    public function testhasPermissionRoleStaffWithNoPerm()
    {
        ...
        $serviceMock
            ...
            ->will($this->returnValue(["cart" => [], "client" => []]));
    ...
    public function testhasPermissionRoleStaffWithNoMethodPerm()
    {
        ...
        $serviceMock
            ->expects($this->atLeastOnce())
            ->method("getPermissions")
            ->will($this->returnValue(["example" => [], "client" => []]));
    ...
    public function testhasPermissionRoleStaffWithGoodPerms()
    {
        ...
        $serviceMock
            ...
            ->method("getPermissions")
            ->will(
                $this->returnValue(["example" => ["get_list"], "client" => []])
            );
    ...
    public function testonAfterClientReplyTicket()
    {
        ...
        $supportServiceMock = $this->getMockBuilder(
        ...
        $emailServiceMock = $this->getMockBuilder(
    ...
    public function testcreate_Exception()
    {
        ...
        $this->expectExceptionMessage(
            sprintf(
                "Staff member with email %s is already registered",
                $data["email"]
            )
        );
        $service->create($data);
    ...
    public function testcreateAdmin()
    {
        ...
        $emailServiceMock->expects($this->atLeastOnce())->method("sendMail");
    ...
    public function testdeleteGroupDeleteAdminGroup()
    {
        ...
        $this->expectException(\Box_Exception::class);
        $this->expectExceptionMessage(
            "Administrators group can not be removed"
        );
    ...
    public function testgetActivityAdminHistorySearchQuery(
        $data,
        $expectedStr,
        $expectedParams
    ) {
    ...
    {
        $pdoStatementMock = $this->getMockBuilder(
            "\Box\Mod\Staff\PdoStatementMock"
        )->getMock();
        ...
        $member_id = 1;
        $result = $service->setPermissions($member_id, []);
        $this->assertTrue($result);
    }
