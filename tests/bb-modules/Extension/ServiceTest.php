...
class ServiceTest extends \BBTestCase
{
    ...
    public function testgetExtensionsList()
    {
        ...
        $dbMock
            ->expects($this->atLeastOnce())
            ->method("find")
            ->will($this->returnValue([$modelFind]));
    ...
    public function testgetAdminNavigation()
    {
        ...
        $pdoStatment = $this->getMockBuilder(
            "\Box\Mod\Extension\PdoStatmentsMock"
        )->getMock();
    ...
    public function testupdateExtensionInformationException()
    {
        ...
        $this->expectExceptionMessage(
            sprintf("Could not retrieve %s information", $model->name)
        );
        $this->service->update($model);
    }
    ...
    public function testupdateNoNeedToUpdateException()
    {
        ...
        $this->expectExceptionMessage(
            sprintf(
                "Latest %s version installed. No need to update",
                $model->name
            ),
            785
        );
    ...
    public function testupdateLastestVersionException()
    {
        ...
        $this->expectExceptionMessage(
            sprintf(
                "Could not retrieve version information for extension %s",
                $model->name
            )
        );
        $this->service->update($model);
    ...
    public function testactivate()
    {
        ...
        $modMock
            ->expects($this->atLeastOnce())
            ->method("getManifest")
            ->will($this->returnValue(["version" => 1]));
    ...
    public function testdeactivateCoreModuleException()
    {
        ...
        $modMock
            ->expects($this->atLeastOnce())
            ->method("getCoreModules")
            ->will($this->returnValue([$ext->name]));
    ...
    {
        $extensionMock = $this->getMockBuilder(
            \Box_Extension::class
        )->getMock();
        ...
        $extensionMock
            ->expects($this->atLeastOnce())
            ->method("getExtension")
            ->will($this->returnValue(["download_url" => "www.boxbillig.com"]));

        $curlMock = $this->getMockBuilder(\Box_Curl::class)
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $zipArchiveMock
            ...
            ->method("open")
            ->will($this->returnValue(true));
        $zipArchiveMock->expects($this->atLeastOnce())->method("extractTo");
        $zipArchiveMock->expects($this->atLeastOnce())->method("close");
        ...
        $toolsMock
            ...
            ->method("rename")
            ->will($this->returnValue(true));
        $toolsMock->expects($this->atLeastOnce())->method("emptyFolder");
    ...
    public function testdownloadAndExtractTranslationException()
    {
        ...
        $toolsMock
            ...
            ->method("fileExists")
            ->will($this->returnValue(false));
        $toolsMock->expects($this->atLeastOnce())->method("mkdir");
        $toolsMock
            ->expects($this->atLeastOnce())
            ->method("rename")
            ->will($this->returnValue(false));
    ...
    {
        $pdoStatment = $this->getMockBuilder(
            \Box\Mod\Extension\PdoStatmentsMock::class
        )->getMock();
        $pdoStatment->expects($this->atLeastOnce())->method("execute");
        $pdoStatment
            ->expects($this->atLeastOnce())
    ...
    public function testactivateExistingExtension()
    {
        ...
        $serviceMock = $this->getMockBuilder("\Box\Mod\Extension\Service")
            ->setMethods(["findExtension", "activate"])
            ->getMock();
        $serviceMock
            ->expects($this->atLeastOnce())
