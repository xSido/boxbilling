...
class Api_AdminTest extends \BBTestCase
{
    ...
    public function testEmail_get()
    {
        ...
        $service = $this->getMockBuilder("Box\Mod\Email\Service")
            ->setMethods(["getEmailById", "toApiArray"])
            ->getMock();
        $service
            ->expects($this->atLeastOnce())
            ->method("getEmailById")
    ...
    public function testSend()
    {
        ...
        $emailService = $this->getMockBuilder("Box\Mod\Email\Service")
            ->setMethods(["sendMail"])
            ->getMock();
        $emailService
            ->expects($this->atLeastOnce())
    ...
    public function testTemplate_reset()
    {
        ...
        $emailService = $this->getMockBuilder("Box\Mod\Email\Service")
            ->setMethods(["resetTemplateByCode"])
            ->getMock();
        $emailService
            ->expects($this->atLeastOnce())
    ...
    public function testBatch_template_generate()
    {
        $adminApi = new \Box\Mod\Email\Api\Admin();
        $emailService = $this->getMockBuilder("Box\Mod\Email\Service")
            ->setMethods(["templateBatchGenerate"])
            ->getMock();
        $emailService
            ->expects($this->atLeastOnce())
    ...
    public function testBatch_template_disable()
    {
        $adminApi = new \Box\Mod\Email\Api\Admin();
        $emailService = $this->getMockBuilder("Box\Mod\Email\Service")
            ->setMethods(["templateBatchDisable"])
            ->getMock();
        $emailService
            ->expects($this->atLeastOnce())
    ...
    public function testBatch_template_enable()
    {
        $adminApi = new \Box\Mod\Email\Api\Admin();
        $emailService = $this->getMockBuilder("Box\Mod\Email\Service")
            ->setMethods(["templateBatchEnable"])
            ->getMock();
        $emailService
            ->expects($this->atLeastOnce())
    ...
    {
        $adminApi = $this->getMockBuilder("Box\Mod\Email\Api\Admin")
            ->setMethods(["template_get"])
            ->getMock();
        $adminApi
            ->expects($this->atLeastOnce())
            ->method("template_get")
            ->will($this->returnValue(["vars" => [], "content" => "content"]));

        $loader = new \Twig\Loader\ArrayLoader();
        $twig = $this->getMockBuilder("Twig\Environment")
            ->setConstructorArgs([$loader, ["debug" => false]])
            ->getMock();
    ...
    {
        $activityMock = $this->getMockBuilder("\Box\Mod\Email\Api\Admin")
            ->setMethods(["email_delete"])
            ->getMock();
        $activityMock
            ->expects($this->atLeastOnce())
            ->method("email_delete")
