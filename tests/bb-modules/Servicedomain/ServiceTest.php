...
class ServiceTest extends \BBTestCase
{
    ...
    public function testValidateOrderData(
        $data,
        $finOneByTldCalled,
        $canBeTransferedCalled,
        $isDomainAvailableCalled
    ) {
        ...
        $serviceMock
            ->expects($finOneByTldCalled)
            ->method("tldFindOneByTld")
            ->will($this->returnValue($tld));
        $serviceMock
            ->expects($canBeTransferedCalled)
            ->method("canBeTransfered")
            ->will($this->returnValue(true));
        $serviceMock
            ->expects($isDomainAvailableCalled)
            ->method("isDomainAvailable")
            ->will($this->returnValue(true));
     ...
     */
    public function testValidateOrderDateOwndomainOwndomain(
        $data,
        $isSldValidCalled,
        $isSldValidReturn
    ) {
     ...
     */
    public function testValidateOrderDateTransferExceptions(
        $data,
        $isSldValidArr,
        $tldFindOneByTldArr,
        $canBeTransfered
        ...
        $serviceMock = $this->getMockBuilder("\Box\Mod\Servicedomain\Service")
            ->setMethods(["tldFindOneByTld", "canBeTransfered"])
            ->getMock();
        $serviceMock
            ->expects($tldFindOneByTldArr["called"])
            ->method("tldFindOneByTld")
            ->will($this->returnValue($tldFindOneByTldArr["returns"]));
        $serviceMock
            ->expects($canBeTransfered["called"])
            ->method("canBeTransfered")
     ...
     */
    public function testValidateOrderDateRegisterExceptions(
        $data,
        $isSldValidArr,
        $tldFindOneByTldArr,
        $canBeTransfered
        ...
        $serviceMock = $this->getMockBuilder("\Box\Mod\Servicedomain\Service")
            ->setMethods(["tldFindOneByTld", "isDomainAvailable"])
            ->getMock();
        $serviceMock
            ->expects($tldFindOneByTldArr["called"])
            ->method("tldFindOneByTld")
    ...
    public function testActionCreate()
    {
        ...
        $serviceMock = $this->getMockBuilder("\Box\Mod\Servicedomain\Service")
            ->setMethods(["tldFindOneByTld", "validateOrderData"])
            ->getMock();
        $serviceMock
            ->expects($this->atLeastOnce())
            ->method("tldFindOneByTld")
    ...
    {
        return [
            ["register", $this->atLeastOnce(), $this->never()],
            ["transfer", $this->never(), $this->atLeastOnce()],
        ];
    }
    ...
    public function testActionActivate(
        ...
        $registrarAdapterMock = $this->getMockBuilder(
            "Registrar_Adapter_Custom"
        )
            ->disableOriginalConstructor()
            ->getMock();
        $registrarAdapterMock
            ->expects($registerDomainCalled)
            ->method("registerDomain")
            ->will($this->returnValue(null));
        $registrarAdapterMock
            ->expects($transferDomainCalled)
            ->method("transferDomain")
            ->will($this->returnValue(null));

        $serviceMock = $this->getMockBuilder("\Box\Mod\Servicedomain\Service")
            ->setMethods(["_getD", "syncWhois"])
            ->getMock();
        $serviceMock
            ->expects($this->atLeastOnce())
            ->method("_getD")
    ...
    public function testActionRenew()
    {
        ...
        $registrarDomainMock = $this->getMockBuilder("Registrar_Domain")
            ->disableOriginalConstructor()
            ->getMock();
        $registrarDomainMock
            ->expects($this->atLeastOnce())
            ->method("getContactRegistrar")
    ...
    public function testEnablePrivacyProtection()
    {
        ...
        $registrarAdapterMock
            ->expects($this->atLeastOnce())
            ->method("enablePrivacyProtection")
            ->will($this->returnValue(null));
    ...
    public function testDisablePrivacyProtection()
    {
        ...
        $registrarAdapterMock
            ->expects($this->atLeastOnce())
            ->method("disablePrivacyProtection")
            ->will($this->returnValue(null));
    ...
    public function testCanBeTransfered()
    {
        ...
        $registrarAdapterMock
            ->expects($this->atLeastOnce())
            ->method("isDomainCanBeTransfered")
            ->will($this->returnValue(true));

        $serviceMock = $this->getMockBuilder("\Box\Mod\Servicedomain\Service")
            ->setMethods(["registrarGetRegistrarAdapter"])
            ->getMock();
        $serviceMock
            ->expects($this->atLeastOnce())
            ->method("registrarGetRegistrarAdapter")
    ...
    public function toApiArrayProvider()
    {
        ...
        return [[$model, $this->atLeastOnce()], [null, $this->never()]];
    }
    ...
    public function testOnBeforeAdminCronRun()
    {
        ...
        $boxEventMock = $this->getMockBuilder("\Box_Event")
            ->disableOriginalConstructor()
            ->getMock();
        $boxEventMock
            ->expects($this->atLeastOnce())
    ...
    {
        $serviceMock = $this->getMockBuilder("\Box\Mod\Servicedomain\Service")
            ->setMethods(["syncExpirationDate"])
            ->getMock();
        $serviceMock
            ->expects($this->atLeastOnce())
            ->method("syncExpirationDate")
            ->will($this->returnValue(null));

        $systemServiceMock = $this->getMockBuilder("\Box\Mod\System\Service")
            ->setMethods(["getParamValue", "setParamValue"])
            ->getMock();
        $systemServiceMock
            ->expects($this->atLeastOnce())
        ...
        $di["db"] = $dbMock;
        $di["logger"] = $di["logger"] = $this->getMockBuilder(
            "Box_Log"
        )->getMock();
        $serviceMock->setDi($di);
     ...
     */
    public function testTldGetSearchQuery(
        $data,
        $expectedQuery,
        $expectedBindings
    ) {
    ...
    public function testRegistrarGetSearchQuery()
    {
        ...
        $this->assertEquals(
            "SELECT * FROM tld_registrar ORDER BY name ASC",
            $query
        );
        $this->assertIsArray($bindings);
    ...
    {
        $serviceMock = $this->getMockBuilder("\Box\Mod\Servicedomain\Service")
            ->setMethods(["registrarGetConfiguration"])
            ->getMock();
        $serviceMock
            ->expects($this->atLeastOnce())
            ->method("registrarGetConfiguration")
            ->will($this->returnValue([]));
        $di = new \Box_Di();
        ...
        $this->assertInstanceOf(
            "Registrar_Adapter_" . $model->registrar,
            $result
        );
    }
    ...
    public function testRegistrarToApiArray()
    {
        ...
        $serviceMock = $this->getMockBuilder("\Box\Mod\Servicedomain\Service")
            ->setMethods([
                "registrarGetRegistrarAdapterConfig",
                "registrarGetConfiguration",
            ])
            ->getMock();
        $serviceMock
            ->expects($this->atLeastOnce())
            ->method("registrarGetRegistrarAdapterConfig")
            ->will($this->returnValue($config));
        $serviceMock
            ->expects($this->atLeastOnce())
            ->method("registrarGetConfiguration")
