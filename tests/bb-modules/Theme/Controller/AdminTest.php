...
class AdminTest extends \BBTestCase
{
    ...
    public function testregister()
    {
        $boxAppMock = $this->getMockBuilder("\Box_App")
            ...
            ->getMock();
        $boxAppMock->expects($this->exactly(1))->method("get");
    ...
    public function testget_theme()
    {
        ...
        $themeMock
            ...
            ->willReturn("");
        $themeMock->expects($this->atLeastOnce())->method("getName");
        $themeMock->expects($this->atLeastOnce())->method("getUploadedAssets");
        $themeMock->expects($this->atLeastOnce())->method("getSnippets");
        $themeMock
            ->expects($this->atLeastOnce())
    ...
    public function testsave_theme_settings_PathIsNotWritable()
    {
        ...
        $themeServiceMock
            ...
            ->method("regenerateThemeSettingsDataFile")
            ->willThrowException(
                new \Exception("PHPUnit controoled exception")
            );
