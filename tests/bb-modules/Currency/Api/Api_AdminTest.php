...
class Api_AdminTest extends \BBTestCase
{
    ...
    public function testGetDefault()
    {
        ...
        $this->assertEquals(
            (float) $model->conversion_rate,
            $returnArr["conversion_rate"]
        );
    ...
    public function testCreateException(
        ...
        $service
            ->expects($getByCodeCalled)
            ->method("getByCode")
            ->will($this->returnValue($getByCodeReturn));

        $service
            ->expects($getAvailableCurrenciesCalled)
            ->method("getAvailableCurrencies")
            ->will($this->returnValue($this->availableCurrencies));
    ...
    public function testDeleteException()
    {
        ...
        $validatorMock
            ->expects($this->atLeastOnce())
            ->method("checkRequiredParamsForArray")
            ->willThrowException(new \Box_Exception(""));
        ...
        $adminApi->setService($service);
        $this->expectException(\Box_Exception::class);
        $adminApi->delete([]); //Expecting \Box_Exception every time
    }
    ...
    public function testDelete()
    {
        ...
        $service = $this->getMockBuilder("\Box\Mod\Currency\Service")
            ->setMethods(["deleteCurrencyByCode"])
            ->getMock();
        $service
            ->expects($this->atLeastOnce())
