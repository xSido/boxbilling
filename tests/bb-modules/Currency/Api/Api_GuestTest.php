...
class Api_GuestTest extends \BBTestCase
{
    ...
    public function getProvider()
    {
        ...
        return [
            ...
            [[], $model, $this->never(), $this->atLeastOnce()],
        ];
    }
    ...
    public function testGetException()
    {
        ...
        $result = $guestApi->get([]); //Expecting \Box_Exception
    }
    ...
    public function testFormatPriceFormat($price_format, $expectedResult)
    {
        ...
        $guestApi = $this->getMockBuilder("\Box\Mod\Currency\Api\Guest")
            ->setMethods(["get"])
            ->getMock();
        $guestApi
            ->expects($this->atLeastOnce())
